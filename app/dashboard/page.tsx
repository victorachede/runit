  ...
  return (
    <div>
      ...
      <div style={{ marginBottom: "2rem" }}>
        <h1 style={{ fontSize: "1.35rem", fontWeight: 700, color: "#f0f0f0", marginBottom: "0.2rem", letterSpacing: "-0.02em" }}>Dashboard</h1>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: "0.875rem", marginBottom: "2rem" }}>
        {[
          ...
          <div key={stat.label} style={{
            background: "#111", border: "1px solid #1a1a1a", borderRadius: 11, padding: "1.1rem 1.25rem"
          }}>
            <div style={{ fontSize: "1.6rem", fontWeight: 700, color: "#f0f0f0", letterSpacing: "-0.03em", lineHeight: 1 }}>{stat.value}</div>
            <div style={{ fontSize: "0.77rem", color: "#444", marginTop: "0.3rem" }}>{stat.label}</div>
          </div>
        ))}
      </div>
